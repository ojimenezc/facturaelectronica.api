...
public class TicketsController extends BaseController {
    ...
    public GenerateDocumentResponse create(@RequestBody TicketsRequest request) throws IOException, SAXException, ParserConfigurationException {
        ...
        try {
            ...
            base64Xml = signer.sign(companyInformation.get(), tiqueteElectronico.getClave(),
            ...
            loggerService.info("Document number " + tiqueteElectronico.getClave() + " was sent to Hacienda. Location to validate document  = [ " + location.toString() + " ]");
            ...
            loggerService.error("The document number " + (null != tiqueteElectronico ? tiqueteElectronico.getClave() : "") + " was not successfully sent to hacienda. Error cause = " + ex.getErrorMessage());
            ...
            if (null != badRequest) {
                loggerService.error("The document number " + (null != tiqueteElectronico ? tiqueteElectronico.getClave() : "") + " was not successfully sent to hacienda. Error cause = " + badRequest.getResponseHeaders().get("X-Error-Cause"));
