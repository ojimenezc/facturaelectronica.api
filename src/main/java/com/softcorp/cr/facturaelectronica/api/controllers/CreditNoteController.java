...
public class CreditNoteController extends BaseController {
    ...
    public GenerateDocumentResponse create(@RequestBody CreditNoteRequest request) throws IOException, SAXException, ParserConfigurationException {
        ...
        try {
            ...
            base64Xml = signer.sign(companyInformation.get(), notaCreditoElectronica.getClave(),
            ...
            loggerService.info("Document number " + notaCreditoElectronica.getClave() + " was sent to Hacienda. Location to validate document  = [ " + location.toString() + " ]");
            ...
            loggerService.error("The document number " + (null != notaCreditoElectronica ? notaCreditoElectronica.getClave() : "") + " was not successfully sent to hacienda. Error cause = " + ex.getErrorMessage());
            ...
            if (null != badRequest) {
                loggerService.error("The document number " + (null != notaCreditoElectronica ? notaCreditoElectronica.getClave() : "") + " was not successfully sent to hacienda. Error cause = " + badRequest.getResponseHeaders().get("X-Error-Cause"));
